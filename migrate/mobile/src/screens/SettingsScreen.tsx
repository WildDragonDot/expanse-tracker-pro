...
export const SettingsScreen = ({ navigation }: { navigation?: any }) => {
  ...
  const handleLogout = () => {
    Alert.alert('Sign Out', 'Are you sure you want to sign out of Expense Tracker?', [
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.groupedCard, { backgroundColor: colors.surfaceGlass, borderColor: colors.surfaceGlassBorder }]}>
          ...
          >
            ...
            <View style={styles.menuMeta}>
              <Text style={[styles.menuTitle, { color: colors.text }]}>About Expense Tracker</Text>
              <Text style={[styles.menuSub, { color: colors.textMuted }]}>
                v2.4.0 • Release Edition
              </Text>
            </View>
            <ChevronRight color={colors.textMuted} size={16} />
          </TouchableOpacity>
          ...
          <View style={[styles.modalCard, { backgroundColor: colors.surface, borderColor: colors.surfaceGlassBorder }]}>
            ...
            <View style={{ gap: 10, marginBottom: 16 }}>
              <Text style={[styles.toggleDesc, { color: colors.textMuted }]}>
                • <Text style={{ color: colors.text, fontWeight: '700' }}>Email:</Text> support@expensetracker.app
              </Text>
              <Text style={[styles.toggleDesc, { color: colors.textMuted }]}>
                • <Text style={{ color: colors.text, fontWeight: '700' }}>Telegram VIP:</Text> @expensetracker_vip
              </Text>
              <Text style={[styles.toggleDesc, { color: colors.textMuted }]}>
                • <Text style={{ color: colors.text, fontWeight: '700' }}>Docs:</Text> docs.expensetracker.app
              </Text>
            </View>
      ...
      <Modal visible={activeModal === 'about'} animationType="slide" transparent onRequestClose={() => setActiveModal(null)}>
        <View style={styles.modalOverlay}>
          ...
          <View style={[styles.modalCard, { backgroundColor: colors.surface, borderColor: colors.surfaceGlassBorder }]}>
            <View style={styles.modalHeader}>
              <Text style={[styles.modalTitle, { color: colors.text }]}>About Expense Tracker</Text>
              <TouchableOpacity onPress={() => setActiveModal(null)} style={styles.closeBtn}>
                <X color={colors.text} size={18} />
              </TouchableOpacity>
            </View>
            ...
            <View style={{ gap: 6, marginBottom: 16 }}>
              <Text style={[styles.toggleTitle, { color: colors.text }]}>Expense Tracker Mobile</Text>
              <Text style={[styles.toggleDesc, { color: colors.textMuted }]}>Version 2.4.0 (Build 2026.09.07)</Text>
              <Text style={[styles.toggleDesc, { color: colors.textMuted }]}>Built natively for Android with Expo & Firebase Cloud.</Text>
            </View>
